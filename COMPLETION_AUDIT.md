...
| Preparación de producción | `PRODUCTION_READINESS.md`, `VPS_INPUTS.md` | Lista datos necesarios, variables `.env`, gate final, prueba manual obligatoria, criterios de no apertura y ficha corta para recopilar dominio/SSH/CRM/privacidad/proveedor IA antes de tocar el VPS | Hecho base |
