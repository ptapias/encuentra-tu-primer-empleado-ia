...
- `CRM_Dashboard.html`: dashboard interno para revisar métricas de embudo, filtrar leads por oferta/estado/origen, ver conversación, outcome, oferta recomendada, consentimiento, feedback estructurado, cambiar estado/oferta manualmente y exportar CSV.
