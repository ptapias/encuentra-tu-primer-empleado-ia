...
FIELDS = [
    ...
    ("Acceso y dominio", "¿El dominio ya apunta al VPS?", "sí", "sí/no"),
    ...
    ("IA y transcripción", "¿Codex CLI ya está logueado con ese usuario?", "no", "sí/no"),
    ...
    ("CRM y seguridad", "Contraseña real CRM", "", "Mínimo 16 caracteres"),
    ...
    ("CRM y seguridad", "Secreto webhook", "", "Déjalo vacío si no hay webhook"),
