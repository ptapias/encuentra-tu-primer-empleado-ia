    ...
    steps = [
        run_step(
            ...
            [
                ...
                "test_public_beta_gate.py",
                "test_vps_inputs_validator.py",
                "test_prepare_vps_launch_files.py",
                "test_manual_production_validator.py",
                "test_beta_readiness_status.py",
                "test_generate_vps_inputs.py",
                "test_print_vps_deploy_commands.py",
                "render_privacy.py",
                "validate_vps_inputs.py",
                "prepare_vps_launch_files.py",
                "print_vps_deploy_commands.py",
                "validate_manual_production_test.py",
        ...
        run_step("private_report_link", [sys.executable, "test_private_report_link.py"]),
        ...
        run_step("public_beta_gate", [sys.executable, "test_public_beta_gate.py"]),
        run_step("vps_inputs_validator", [sys.executable, "test_vps_inputs_validator.py"]),
        run_step("prepare_vps_launch_files", [sys.executable, "test_prepare_vps_launch_files.py"]),
        run_step("manual_production_validator", [sys.executable, "test_manual_production_validator.py"]),
        ...
        run_step("print_vps_deploy_commands", [sys.executable, "test_print_vps_deploy_commands.py"]),
        static_page_check(),
