...
def main() -> int:
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            page.get_by_text("escucha, repregunta y separa").wait_for(timeout=5000)
            page.get_by_role("button", name="Empezar conversación").wait_for(timeout=5000)
            ...
            cta_box = mobile.get_by_role("button", name="Empezar conversación").bounding_box()
